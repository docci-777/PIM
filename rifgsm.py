...
def get_params():
    parser = argparse.ArgumentParser(description='RIM Params')
    ...
    parser.add_argument('--log_dir', default='ri_log', type=str)
    parser.add_argument('--log_name', default='ri_result', type=str)
...
def main():
    ...
    atk = RIM(source_model, eps=args.eps, alpha=args.alpha, steps=args.steps, m1=args.m1, m2=args.m2,
